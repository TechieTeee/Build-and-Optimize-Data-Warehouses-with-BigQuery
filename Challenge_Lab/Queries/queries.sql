CREATE OR REPLACE TABLE covid_806.oxford_policy_tracker_436
PARTITION BY date
OPTIONS(
...
WHERE
 ...
 ALTER TABLE covid_806.oxford_policy_tracker_436
...
CREATE OR REPLACE TABLE covid_806.pop_data_2019 AS
SELECT
...
ORDER BY
  ...
  UPDATE
   `covid_806.oxford_policy_tracker_436` t0
SET
   population = t1.pop_data_2019
FROM
   `covid_806.pop_data_2019` t1
WHERE
...
FROM `covid_806.oxford_policy_tracker_436`
